import CustomTextInput from './CustomInput.vue';
...
export { CustomTextInput as CustomInput, CustomInputState, CustomTextInputGroupController, CustomInputStyles, Utils };
